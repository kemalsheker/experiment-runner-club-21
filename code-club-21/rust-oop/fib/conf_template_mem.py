...
class RunnerConfig:
    ...
    def start_run(self, context: RunnerContext) -> None:
        ...
        # start the target
        self.target = subprocess.Popen([program],
    ...
    def start_measurement(self, context: RunnerContext) -> None:
        ...
        profiler_cmd = f'ps -o rss= -p {self.target.pid}'

        #profiler_cmd = f'ps -p {self.target.pid} --noheader -o %cpu'
        wrapper_script = f'''
        while true; do {profiler_cmd} >> mem_output.txt; sleep 1; done
        '''
