---
title: "R Notebook for Wilcoxon Test For Scala"
...
combined_data_energy_sc_oop <- NULL  # Initialize an empty data frame or vector

for (file_path in file_paths_energy_sc_oop) {
  data <- scan(file_path, what = numeric())
  combined_data_energy_sc_oop <- c(combined_data_energy_sc_oop, data)  # Combine data from each file
}



file_paths_energy_sc_fun <- list(
...
combined_data_energy_sc_fun <- NULL  # Initialize an empty data frame or vector

for (file_path in file_paths_energy_sc_fun) {
  data <- scan(file_path, what = numeric())
  combined_data_energy_sc_fun <- c(combined_data_energy_sc_fun, data)  # Combine data from each file
}


wilcox.test(combined_data_energy_sc_oop, combined_data_energy_sc_fun, paired=TRUE) 
